...
export default function AboutPage() {
    return (
        <ContentPage title="ℹ️ About & Contact">
            <div className="info-card" style={{ marginTop: '24px' }}>
                ...
                <div style={{ background: 'var(--bg-glass)', padding: '16px', borderRadius: '8px', border: '1px solid var(--border-color)' }}>
                    <Link href="/munsimulation" target="_blank" rel="noopener noreferrer"
                        style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', color: 'var(--accent-blue)', textDecoration: 'none', padding: '8px 12px', background: 'rgba(74, 144, 226, 0.1)', borderRadius: '6px', fontSize: '0.9em' }}>
