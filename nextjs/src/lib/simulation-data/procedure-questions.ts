export const procedureQuestions = [
    {
        phase: "Roll call",
        scenario:
    ...
    },
    {
        phase: "Moderated caucus",
        scenario:
            "The topic of the moderated caucus is 'Humanitarian access.' A delegate begins speaking about climate change. What do you do?",
        options: [
